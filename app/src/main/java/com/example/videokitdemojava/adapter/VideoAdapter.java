package com.example.videokitdemojava.adapter;
...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.VideoViewHolder> {
    ...
    public VideoAdapter(Context context, List<Movie> movieList, onMovieListener onMovieListener) {
    ...
    public void onBindViewHolder(@NonNull VideoViewHolder holder, int position) {
        ...
        holder.url.setText("Video Description");
