package com.example.videokitdemojava.utils;
...
public class Constants {
     ...
     * Media Names
     */
    public static final String MEDIA1_NAME = "For Bigger Escape";
    public static final String MEDIA2_NAME = "For Bigger Fun";
    public static final String MEDIA3_NAME = "For Bigger Joyrides";
    public static final String MEDIA4_NAME = "For Bigger Meltdowns";


    /**
     * Media Urls
     */
    public static final String MEDIA1_URL = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4";
    public static final String MEDIA2_URL = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4";
    public static final String MEDIA3_URL = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4";
    public static final String MEDIA4_URL = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4";
